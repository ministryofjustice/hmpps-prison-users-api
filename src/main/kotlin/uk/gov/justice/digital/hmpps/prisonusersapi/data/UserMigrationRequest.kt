...
data class UserMigrationRequest(
    ...
    @NotEmpty(message = "Expected at least one 'user'")
    val user: MigratedUser,

    @Schema(required = true, description = "The NOMIS user accounts to migrate")
    @NotEmpty(message = "Expected at least one 'user account'")
...
data class MigratedUserAccount(
    ...
    @Schema(required = true, description = "The user account status indicating if it is open, locked or expired", type = "string",
